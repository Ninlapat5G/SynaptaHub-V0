...
ถ้างานเกี่ยวกับการเปิดสื่อ เพลง หรือเนื้อหาที่ไม่มี URL ชัดเจน — ให้ใช้ web_search หา link ที่ถูกต้องก่อน แล้วต้องรัน os_exec เพื่อเปิดจริงๆ ห้ามแค่รายงาน URL กลับโดยไม่ได้เปิด
